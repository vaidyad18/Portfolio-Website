...
const Skills = () => {
  ...
  useEffect(() => {
    ...
    gsap.to(scrollContentRef.current, {
      x: () => `-${scrollWidth - viewportWidth+500 }px`,
      ease: "none",
      duration: 0.5,
      scrollTrigger: {
  ...
  return (
    ...
    >
      ...
      >
        <div className="text-center ml-40 mr-96 " data-aos="zoom-out">
          <p className="text-[25rem] text-white font-sans">SKILLS</p>
        </div>
        ...
        <img
          className="c1 absolute w-24 bottom-[370px] left-[2400px] -rotate-12"
          src="https://avatars.githubusercontent.com/u/13841574?v=4"
          alt=""
        />
        <img
          className="c2 absolute w-24 bottom-[210px] left-[2030px] rotate-12"
          src="https://avatars.githubusercontent.com/u/13841574?v=4"
          alt=""
        />
        <img
        ...
        />
        <img
          className="absolute c8  w-32 bottom-[340px] left-[5800px] rotate-12"
        ...
        />
        <img
          className="absolute c9 w-32 bottom-[180px] left-[5490px] -rotate-45"
          src="https://static.vecteezy.com/system/resources/previews/027/127/463/non_2x/javascript-logo-javascript-icon-transparent-free-png.png"
          alt=""
        />
        <img
          className="absolute c10 w-32 bottom-[270px] left-[5080px] -rotate-12"
          src="https://static.vecteezy.com/system/resources/previews/027/127/463/non_2x/javascript-logo-javascript-icon-transparent-free-png.png"
          alt=""
        />
        <img
          className="absolute c11 w-32 bottom-[350px] left-[4690px] rotate-12"
          src="https://static.vecteezy.com/system/resources/previews/027/127/463/non_2x/javascript-logo-javascript-icon-transparent-free-png.png"
          alt=""
        />
        <img
        ...
        />
        <img
          className="absolute c19 w-32 bottom-[220px] left-[8800px]  rotate-12 "
          src="https://upload.wikimedia.org/wikipedia/commons/thumb/d/d5/Tailwind_CSS_Logo.svg/2560px-Tailwind_CSS_Logo.svg.png"
          alt=""
        />
        <img
