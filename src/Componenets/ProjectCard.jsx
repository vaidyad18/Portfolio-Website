...
function ProjectCard(props) {
  return (
    <div className='md:h-[340px] h-[210px] w-[340px] sm:h-[280px] sm:w-[500px] md:w-[600px] hover:scale-105 duration-500 rounded-3xl shadow-[40px_25px_50px_-15px_rgba(255,255,255,0.2)] border-white border-4 overflow-hidden relative group mb-12'>
